    ...
    <div id="universitie">
      <div className="uniblock">
            ...
            <div className="uni_landing">
                <div className="uni_land_left">
                    ...
                    <div className="uni_btn">
                        <Link href='/university_registration' className='uni_button'>Contact us</Link>
                    </div>
                    
                </div>
                <div className="uni_land_right">
                    <img src='https://droneairgear.com/assets/group_study-d1c91d18.png' alt="" />
                </div>
            </div>
            </div>
        ...
        <div className="uni_partners">
            ...
            <img className='partners_img' src='https://droneairgear.com/assets/comp-logo-35bca777.png' alt="" />
        </div>
        </div>
        ...
        <div className="uni_imp">
            <div className="uni_imp_left">
                <img src='https://droneairgear.com/assets/handjob-b751410a.png' alt="" />
            </div>
